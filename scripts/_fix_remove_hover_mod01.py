"""
Remove all hover effects from mod_01_getting_started lesson files,
...
FOLDER = pathlib.Path("pages/mod_01_getting_started")
...
def parse_css_blocks(css):
    """Split CSS into top-level blocks: (kind, selector, body)."""
    blocks = []
    i = 0
    n = len(css)
    while i < n:
...
print("\nDone — all hover effects removed except lesson-nav-link.")
